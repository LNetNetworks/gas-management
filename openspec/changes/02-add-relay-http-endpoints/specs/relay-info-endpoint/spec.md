...
del contrato de reglas cuando aplique, y si el nodo que relaya esta permitido.
...
incluidos los del reordenamiento de nonces. Un operador tiene que poder confirmar que el servicio
tomo la configuracion que cree haberle puesto, sin entrar al nodo a leer el archivo.
